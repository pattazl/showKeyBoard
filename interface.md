...
对于 节点 MinuteRecords 说明如下

1. 有操作数据才更新APP信息
2. 每次最多只上传10分钟以内的APP信息
3. 如果一分钟内有多个APP操作，记录到数组中平均分配时间
4. 服务端根据 Minute 时间增量记录数据
...
| ahkKeyShow           | 用于通过WS获取实时按键信息，示例代码可参考 ui-helper\getWSMsg.js |
